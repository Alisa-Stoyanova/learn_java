...
public abstract class TestBasisklasse {
  ...
  /**
   * Prüft ob die Klasse klasse von der Klasse basis erbt.
   * 
   * @param klasse Klasse, die das Interface implementieren soll.
   * @param basis  Klasse von der geerbt werden soll.
   */
  protected boolean testErbtVon(Class<?> klasse, Class<?> basis) {
    Class<?> superclass = klasse.getSuperclass();
    return superclass == basis;
  }
